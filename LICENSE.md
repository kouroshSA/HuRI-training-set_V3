...
covered material described above. They are conditions of, and obligations
under, every license granted for that material — including any separate
commercial license granted by the copyright holder, unless that commercial
license expressly states otherwise. If there is any conflict between these
Additional Terms and the PolyForm Noncommercial License 1.0.0 text below,
these Additional Terms control to the extent of the conflict.

## 1. Citation and Attribution

If you use the covered material, or any part of it, or any derivative or
modified version of it — in any work, including research, software, products,
...
**This is in addition to, not instead of, citing HuRI.** Any use of the data or
of datasets derived from it must cite Luck et al. 2020 (see `REFERENCES.md`).

## 2. License Propagation (modified versions)

Every copy, modified version, fork, or derivative of the covered material —
**whether commercial or noncommercial, and whether or not it is distributed** —
must include a complete, unaltered copy of this entire LICENSE file (these
Additional Terms together with the PolyForm Noncommercial License 1.0.0 text
below) and must preserve all copyright notices and every line beginning with
`Required Notice:`. These Additional Terms continue to apply to all such
modified versions and derivatives.
